...
public class FavPostFragment extends Fragment {
    ...
    String myId;
    private String TAG = "ProfileFavFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fav_post, container, false);
        ...
        POST_LIST_URL = ServerAdress.host + "fav_post_list.php";
